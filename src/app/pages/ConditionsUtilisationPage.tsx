        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              En utilisant Adresse Postale Web (ci-après "le Service"), vous acceptez les présentes conditions d'utilisation. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser le Service. Adresse Postale Web se réserve le droit de modifier ces conditions à tout moment. Les modifications entrent en vigueur dès leur publication sur cette page.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Adresse Postale Web est une plateforme numérique permettant à ses utilisateurs de créer des adresses numériques géolocalisées, de les partager et d'y accéder via un lien unique. Le Service est accessible sans création de compte obligatoire pour les fonctionnalités de base.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">3. Utilisation autorisée</h2>
            <p className="text-gray-600 leading-relaxed mb-3">Vous vous engagez à utiliser Adresse Postale Web uniquement à des fins légales et conformément aux présentes conditions. Il est notamment interdit de :</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
              ...
              <li>Tenter de pirater, surcharger ou perturber les serveurs d'Adresse Postale Web.</li>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Les adresses créées par les utilisateurs leur appartiennent. En créant une adresse publique, l'utilisateur accorde à Adresse Postale Web une licence non-exclusive, gratuite et mondiale pour afficher cette adresse dans le cadre du Service. Adresse Postale Web ne revendique aucun droit de propriété sur le contenu créé par les utilisateurs.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">5. Responsabilité et exactitude</h2>
            <p className="text-gray-600 leading-relaxed mb-3">Adresse Postale Web est une plateforme d'hébergement d'adresses créées par ses utilisateurs. À ce titre :</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
              <li>Adresse Postale Web n'est pas responsable de l'exactitude des adresses créées par les utilisateurs.</li>
              <li>La précision de la localisation GPS dépend du dispositif de l'utilisateur et des conditions réseau.</li>
              <li>Adresse Postale Web n'est pas responsable des erreurs de navigation résultant d'adresses imprécises.</li>
              <li>Les informations de repère sont fournies à titre indicatif uniquement.</li>
              <li>Adresse Postale Web ne garantit pas la disponibilité permanente et ininterrompue du Service.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Les données cartographiques affichées sur Adresse Postale Web proviennent d'OpenStreetMap, sous licence Open Database License (ODbL). Les données cartographiques appartiennent aux contributeurs d'OpenStreetMap. Conformément à cette licence, la source est mentionnée sur toutes les cartes affichées.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Dans les limites autorisées par la loi applicable, Adresse Postale Web ne saurait être tenu responsable des dommages directs, indirects, accessoires ou consécutifs résultant de l'utilisation ou de l'impossibilité d'utiliser le Service, y compris les pertes de données, erreurs de livraison ou préjudices commerciaux.
            </p>
          </section>
