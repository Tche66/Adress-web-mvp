...
export function AuthPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col">
      ...
      <PageGuide storageKey="auth" steps={[{"icon": "👋", "title": "Connexion ou inscription", "desc": "Créez un compte gratuit pour créer et gérer vos adresses."}, {"icon": "🆓", "title": "C'est gratuit", "desc": "Le plan gratuit permet de créer des adresses et les partager."}, {"icon": "📧", "title": "Vérifiez votre email", "desc": "Vérifiez votre boîte mail pour confirmer votre compte."}]} />
    </>
  );
}
