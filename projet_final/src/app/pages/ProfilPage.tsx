...
type Tab = 'profil' | 'adresses' | 'api' | 'parametres';
    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="flex border-b border-gray-200 mb-6">
          {(['profil', 'adresses', 'api', 'parametres'] as Tab[]).map(t => (
            <button
              key={t}
            ...
            >
              {t === 'profil' ? '👤 Profil' : t === 'adresses' ? '📍 Adresses' : t === 'api' ? '🔑 API' : '⚙️ Paramètres'}
            </button>
          ))}
        </div>
...
{`curl https://addressweb.app/api/v1/addresses/AW-ABJ-84321 \
  -H "Authorization: Bearer VOTRE_CLE_API"`}
      ...
      <PageGuide storageKey="profil" steps={[{"icon": "👤", "title": "Votre profil", "desc": "Modifiez votre nom, photo et informations personnelles ici."}, {"icon": "📍", "title": "Mes adresses", "desc": "Retrouvez toutes vos adresses créées, partagez-les ou supprimez-les."}, {"icon": "🔑", "title": "Clés API", "desc": "Générez une clé API pour intégrer Address-Web dans vos applications."}, {"icon": "⚙️", "title": "Paramètres", "desc": "Changez votre mot de passe ou gérez les paramètres de votre compte."}]} />
  );
}
