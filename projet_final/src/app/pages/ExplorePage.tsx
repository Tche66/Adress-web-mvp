...
export function ExplorePage() {
  ...
  return (
    <div className="flex flex-col bg-gray-50" style={{ height: '100dvh', maxHeight: '100dvh' }}>
      ...
      <PageGuide storageKey="explore" steps={[{"icon": "🗺️", "title": "Carte des adresses", "desc": "Cette carte affiche toutes les adresses publiques créées sur Address-Web."}, {"icon": "🔍", "title": "Rechercher", "desc": "Utilisez la barre de recherche pour trouver par ville, repère ou code AW."}, {"icon": "📌", "title": "Cliquer sur un pin", "desc": "Cliquez sur n'importe quel marqueur pour voir les détails et naviguer vers ce lieu."}]} />
  );
}
